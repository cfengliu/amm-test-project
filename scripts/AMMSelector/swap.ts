...
async function main() {
  ...
  const swapExactTokensForTokens = await ammSelector.swapExactTokensForTokens(
    addr.UNI,
    addr.DAI,
    "1000",
    deadline,
  ...
  const swapTokensForExactTokens = await ammSelector.swapTokensForExactTokens(
    addr.UNI,
    addr.DAI,
    "100",
    deadline,
  ...
  const swapTokensOutOnUniswap = await ammSelector.swapTokensOutOnUniswap(
    encodedPath3,
    addr.UNI,
    "1000",
    deadline,
